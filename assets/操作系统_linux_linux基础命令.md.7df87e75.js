import{_ as s,c as a,o as n,a as l}from"./app.bdc5c4d0.js";const D=JSON.parse('{"title":"\u67E5\u627E && \u65E5\u5FD7","description":"","frontmatter":{},"headers":[{"level":2,"title":"\u67E5\u627E && \u65E5\u5FD7","slug":"\u67E5\u627E-\u65E5\u5FD7"},{"level":2,"title":"\u5176\u4ED6\u5E38\u7528\u64CD\u4F5C","slug":"\u5176\u4ED6\u5E38\u7528\u64CD\u4F5C"}],"relativePath":"\u64CD\u4F5C\u7CFB\u7EDF/linux/linux\u57FA\u7840\u547D\u4EE4.md","lastUpdated":1660640854000}'),p={name:"\u64CD\u4F5C\u7CFB\u7EDF/linux/linux\u57FA\u7840\u547D\u4EE4.md"},e=l(`<ol><li>\u8FDB\u5165\u76EE\u5F55</li></ol><div class="language-text"><span class="copy"></span><pre><code><span class="line"><span style="color:#A6ACCD;">cd \u76EE\u5F55\u540D</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ol start="2"><li>\u663E\u793A\u5F53\u524D\u8DEF\u5F84</li></ol><div class="language-text"><span class="copy"></span><pre><code><span class="line"><span style="color:#A6ACCD;">pwd</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ol start="3"><li>\u663E\u793A\u8DEF\u5F84\u4E0B\u7684\u6587\u4EF6</li></ol><div class="language-text"><span class="copy"></span><pre><code><span class="line"><span style="color:#A6ACCD;">ls</span></span>
<span class="line"><span style="color:#A6ACCD;">ls -a  \u663E\u793A\u9690\u85CF\u6587\u4EF6\u3002\u9690\u85CF\u6587\u4EF6\u4EE5 . \u5F00\u5934\u547D\u540D</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ol start="4"><li>\u67E5\u770B\u521B\u5EFA\u6587\u672C</li></ol><div class="language-text"><span class="copy"></span><pre><code><span class="line"><span style="color:#A6ACCD;">touch abc.txt \u67E5\u770Babc.txt \u5982\u679C\u4E0D\u5B58\u5728\u5219\u81EA\u52A8\u521B\u5EFA</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ol start="5"><li>\u521B\u5EFA\u6587\u4EF6\u5939</li></ol><div class="language-text"><span class="copy"></span><pre><code><span class="line"><span style="color:#A6ACCD;">mkdir \u6587\u4EF6\u540D 			 		\u5F53\u524D\u76EE\u5F55\u521B\u5EFA\u4E00\u4E2A\u6587\u4EF6\u5939</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ol start="6"><li>\u91CD\u547D\u540D\u64CD\u4F5C</li></ol><div class="language-text"><span class="copy"></span><pre><code><span class="line"><span style="color:#A6ACCD;">mv test test1						\u628Atest\u6587\u4EF6\u7684\u540D\u5B57\u4FEE\u6539\u4E3Atest1</span></span>
<span class="line"><span style="color:#A6ACCD;">mv test1 /home/wechat/  			\u5C06test1\u6587\u4EF6 \u79FB\u52A8\u5230/home/wechat \u76EE\u5F55\u4E0B</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ol start="7"><li>\u5220\u9664\u64CD\u4F5C</li></ol><div class="language-text"><span class="copy"></span><pre><code><span class="line"><span style="color:#A6ACCD;">rm file 						\u5220\u9664file\u6587\u4EF6(\u5B58\u5728\u5B50\u6587\u4EF6\u65F6\u4E0D\u53EF\u5220\u9664)</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ol start="8"><li>\u590D\u5236</li></ol><div class="language-text"><span class="copy"></span><pre><code><span class="line"><span style="color:#A6ACCD;">cp file /home  				    \u590D\u5236file\u547D\u4EE4\u81F3home\u76EE\u5F55\u4E0B</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ol start="9"><li>\u538B\u7F29\u3001\u89E3\u538B</li></ol><div class="language-text"><span class="copy"></span><pre><code><span class="line"><span style="color:#A6ACCD;">\u89E3\u538Btar</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ol start="2"><li>find\u547D\u4EE4</li></ol><div class="language-text"><span class="copy"></span><pre><code><span class="line"><span style="color:#A6ACCD;">.\u4EE3\u8868\u5F53\u524D\u76EE\u5F55</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ol start="3"><li>whereis\u547D\u4EE4</li></ol><div class="language-text"><span class="copy"></span><pre><code><span class="line"><span style="color:#A6ACCD;">whereis name/  \u641C\u7D22name\u6587\u4EF6\u7684\u8DEF\u5F84</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ol start="4"><li>grep\u547D\u4EE4</li></ol><div class="language-text"><span class="copy"></span><pre><code><span class="line"><span style="color:#A6ACCD;">ps -ef|grep nginx  			    \u67E5\u770Bnginx\u7684\u8FDB\u7A0B</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ol start="5"><li>tail\u547D\u4EE4</li></ol><div class="language-text"><span class="copy"></span><pre><code><span class="line"><span style="color:#A6ACCD;">tail -f  xxx.log   \u67E5\u770Bxxx.log \u9ED8\u8BA4\u663E\u793A\u6700\u540E10\u884C</span></span>
<span class="line"><span style="color:#A6ACCD;">tail -f 100 xx.log /tail -100f xx.log  \u67E5\u770B100\u884C</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ol start="6"><li>vim\u547D\u4EE4</li></ol><div class="language-text"><span class="copy"></span><pre><code><span class="line"><span style="color:#A6ACCD;">vim</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="\u5176\u4ED6\u5E38\u7528\u64CD\u4F5C" tabindex="-1">\u5176\u4ED6\u5E38\u7528\u64CD\u4F5C <a class="header-anchor" href="#\u5176\u4ED6\u5E38\u7528\u64CD\u4F5C" aria-hidden="true">#</a></h2><ol><li>\u67E5\u770B\u7528\u6237\u4FE1\u606F</li></ol><div class="language-text"><span class="copy"></span><pre><code><span class="line"><span style="color:#A6ACCD;">w</span></span>
<span class="line"><span style="color:#A6ACCD;">who</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ol start="2"><li>\u4FEE\u6539\u6587\u4EF6\u6743\u9650</li></ol><div class="language-text"><span class="copy"></span><pre><code><span class="line"><span style="color:#A6ACCD;">chmod 777 file1 		\u6BCF\u4E2A\u4EBA\u90FD\u53EF\u4EE5\u5BF9file\u6587\u4EF6\u8FDB\u884C\u8BFB\u5199\u548C\u6267\u884C\u7684\u6743\u9650</span></span>
<span class="line"><span style="color:#A6ACCD;">chmod 666 file1 		\u6BCF\u4E2A\u4EBA\u90FD\u53EF\u4EE5\u5BF9file\u6587\u4EF6\u8FDB\u884C\u8BFB\u5199\u64CD\u4F5C</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ol start="3"><li>\u7CFB\u7EDF\u7EA7\u522B</li></ol><div class="language-text"><span class="copy"></span><pre><code><span class="line"><span style="color:#A6ACCD;">top \u5B9E\u65F6\u663E\u793A\u7CFB\u7EDF\u8D44\u6E90\u4F7F\u7528\u60C5\u51B5</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,38),t=[e];function c(o,i,r,A,C,d){return n(),a("div",null,t)}var g=s(p,[["render",c]]);export{D as __pageData,g as default};
